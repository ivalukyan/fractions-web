...
from src.main import task_increased_complexity_router, templates


@task_increased_complexity_router.get('/task_selection/{class_id}/task_increased_complexity/{task_id}/{correct}')
...
@task_increased_complexity_router.post('/task_selection/{class_id}/task_increased_complexity/{task_id}/{correct}')
