...
from src.main import equations_router, templates


@equations_router.get('/task_selection/{class_id}/equations/{task_id}/{correct}')
...
@equations_router.post('/task_selection/{class_id}/equations/{task_id}/{correct}')
